try:
    ...
    from exam_ds.vel_regressor_org import VelRegressorOrg as vel_regressor
    from exam_ds.vel_trainner_dp import train_model
except:
    from ex_model_ds_base import ExamModelBase
    from vel_regressor_org import VelRegressorOrg as vel_regressor
...
class ExamModelDs(ExamModelBase):
    ...
    def ex_get_saved_model_pathnames(cls):
        return "md_conv1d.pt", "/content/drive/MyDrive/md_org.pt"
