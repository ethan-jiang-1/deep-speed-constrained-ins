...
class VelRegressorOrgDa(torch.nn.Module):
    def __init__(self, Nin=6, Nout=1, Nlinear=1860):  # 112 * 60):
        super(VelRegressorOrgDa, self).__init__()
        # Convolutional layers
        self.model1 = torch.nn.Sequential(
            torch.nn.Conv1d(Nin, 60, kernel_size=3, stride=1, groups=Nin),
            torch.nn.ReLU(),
            torch.nn.Conv1d(60, 60, kernel_size=3, stride=1, groups=Nin),
            torch.nn.ReLU(),
            torch.nn.Conv1d(60, 60, kernel_size=3, stride=1),
            torch.nn.ReLU(),
